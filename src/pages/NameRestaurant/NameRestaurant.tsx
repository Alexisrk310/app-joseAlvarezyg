...
const NameRestaurant: React.FC<NameRestaurantInterface> = () => {
  ...
  // restaurant[0].userId == l                disabled={disableRating}ocal?.id || local?.data?.id
  ...
  return (
    <div className="bg-black py-8">
      {/* Portada */}
      <div
        className="bg-center h-64 banner-img"
        style={{
          backgroundRepeat: "repeat-x",
          backgroundImage: `url("${restaurant[0]?.image}")`,
        }}
      >
        ...
        <div className="flex flex-wrap">
          ...
          <div className="w-full md:w-1/4">
            <img
              ...
              alt="imagen de perfil del restaurante"
              className="w-full"
            />
          </div>
          ...
          <div className="w-full md:w-3/4 pl-8">
            ...
            <p className="text-white">{restaurant[0]?.description}</p>
          </div>
        </div>

        {/* Platillos */}
        <h2 className="text-3xl font-bold my-8">Nuestros Platillos</h2>
          ...
          <div className="mt-5 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {plate?.map((plates: any) => (
              <Card
                ...
                eventeModal={() => setplateModal(plates)}
                idData={plates?.id}
                img={plates?.image}
                title={plates?.name}
            ...
            <ModalPlate restaurant={restaurant} data={plateModal} id={idPlateModal} />
            <hr className="mb-0" />
          </div>
        </div>
      </div>
